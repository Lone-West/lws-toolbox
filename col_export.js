...
async function init() {
    ...
    const exportController = new ThreadController(os.cpus().length, 'col_export_worker.js', collisionFiles, { collisionsFolder })
    ...
    fs.writeFile('collisions.json', JSON.stringify(result), { encoding: 'utf-8' })
